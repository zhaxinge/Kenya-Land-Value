...
def merge_dropna_transform_split_train_test(c,city, app, X, latlons, ACS=False, seed=0):
    ...
    fsampling = c.sampling["n_samples"]
    ...
    c.outcomes_fpath = join(
            ...
            app,
            city,
            f"outcomes_sampled_houseprice_dense_16_640_regular_{c.meters_per_grid[0]}_{fsampling}.csv"
        )
    ...
    Y = Y.loc[~Y.index.duplicated(keep='first')]  # Remove duplicate index labels
